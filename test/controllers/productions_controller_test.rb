...
class ProductionsControllerTest < ActionController::TestCase
  ...
  test "should create production" do
    assert_difference('Production.count') do
      post :create, production: { product_id: @production.product_id, quntity: @production.quntity, unit: @production.unit }
    end
  ...
  test "should update production" do
    patch :update, id: @production, production: { product_id: @production.product_id, quntity: @production.quntity, unit: @production.unit }
    assert_redirected_to production_path(assigns(:production))
  end
